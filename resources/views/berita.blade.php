...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/mystylee.css') }}" />
  <title>Zona KHAS ITS</title>
</head>
<body>
  <header>
  ...
  <article class="news-article">
    ...
    <figure>
      <img src="{{ asset('css/maaruf.jpg') }}" alt=" " />
      <figcaption>Wakil Presiden Ma'ruf Amin</figcaption>
    </figure>
  </article>
</body>
</html>
